(function () {
    ...
    let homeToStore2 = [
        [33.980001, -118.300489],
        [33.979824, -118.309047],
        [34.061666, -118.309200],
        [34.061726, -118.310439],
        [34.063514, -118.309849]
    ];
    ...
    let homeToSchool2 = [
        [33.980001, -118.300489],
        [33.979820, -118.309052],
        [33.989175, -118.308907],
        [33.989247, -118.400036],
        [34.073037, -118.466200],
        [34.076714, -118.452897]
    ];
    ...
    let homeToStoreAnim2 = L.motion.polyline(homeToStore2, { color: 'green' }, { auto: true, speed: 5000, easing: L.Motion.Ease.easeInOutQuad },
        {
            icon: L.divIcon({ html: "<i class='fa-solid fa-bus-side fa-2x fa-flip-horizontal' aria-hidden='true'></i>", iconSize: L.point(27.5, 24) }),
            removeOnEnd: true
        }).motionDuration(4000);

    let storeToHomeAnim2 = L.motion.polyline(storeToHome2, { color: 'green' }, { auto: false, speed: 5000, easing: L.Motion.Ease.easeInOutQuad },
        {
            icon: L.divIcon({ html: "<i class='fa-solid fa-bus-side fa-2x' aria-hidden='true'></i>", iconSize: L.point(27.5, 24) })
        }).motionDuration(4000);

    let homeToSchoolAnim2 = L.motion.polyline(homeToSchool2, { color: 'green' }, { auto: true, speed: 5000, easing: L.Motion.Ease.easeInOutQuad },
        {
            icon: L.divIcon({ html: "<i class='fa-solid fa-bus-side fa-2x fa-flip-horizontal' aria-hidden='true'></i>", iconSize: L.point(27.5, 24) }),
            removeOnEnd: true
        }).motionDuration(6000);

    let schoolToHomeAnim2 = L.motion.polyline(schoolToHome2, { color: 'green' }, { auto: false, speed: 5000, easing: L.Motion.Ease.easeInOutQuad },
        {
            icon: L.divIcon({ html: "<i class='fa-solid fa-bus-side fa-2x' aria-hidden='true'></i>", iconSize: L.point(27.5, 24) })
        }).motionDuration(6000);
    ...
    let storyText6 = "To your surprise, all train and tram fares are free today. You're not sure why, but it must be an important event.";
    let storyText7 = "You bump into an old friend and decide to spend the day going around the city with them. You two cover a lot of ground, and it doesn't cost a cent over your day pass.";
    let storyText8 = "You feel a murmur in your heart, but it goes away.";
        ...
        setTimeout(() => {
            if (currentChapter == 1) {
                ...
                document.querySelector("#mapPopups").innerHTML = `
                    <div id="trainPopup" class="">
                        <div class="popup">
                            <p><span class="red">Freeways</span> are now trains.</p>
                            <i class="fa-solid fa-xmark" id="hideTrainPopup"></i>
                        </div>
                    </div>
                    <div id="tramPopup" class="">
                        <div class="popup">
                            <p><span class="orange">Main roads</span> are now trams.</p>
                            <i class="fa-solid fa-xmark" id="hideTramPopup"></i>
                        </div>
                    </div>
                `;

                document.querySelector("#hideTrainPopup").addEventListener("click", function () {
                    document.querySelector("#trainPopup").className = "hidden";
                });

                document.querySelector("#hideTramPopup").addEventListener("click", function () {
                    document.querySelector("#tramPopup").className = "hidden";
                });
            }
            setTimeout(() => {
                if (currentChapter == 1) {
    ...
    document.querySelector("#nextButtonMap").addEventListener("click", function () {
        if (currentChapter == 1) {
            ...
            let seq = L.motion.seq([homeToStoreAnim2]).addTo(map);
            seq.addLayer(storeToHomeAnim2, true);
            document.querySelector("#mapButtonArea").className = "hidden";
            setTimeout(function () {
                let questionMarker5 = L.marker([33.980001, -118.300489], { icon: questionIcon }).addTo(map);
                questionMarker5.on("click", function () {
                    currentChapter = 17;
                    document.querySelector("#transitionScreen").className = "fadeToBlack";
                    setTimeout(function () {
                        document.querySelector("#transitionScreen").className = "hidden";
            ...
            let seq = L.motion.seq([homeToSchoolAnim2]).addTo(map);
            seq.addLayer(schoolToHomeAnim2, true);
            document.querySelector("#mapButtonArea").className = "hidden";
            setTimeout(function () {
                let questionMarker6 = L.marker([33.980001, -118.300489], { icon: questionIcon }).addTo(map);
                questionMarker6.on("click", function () {
                    currentChapter = 20;
                    document.querySelector("#transitionScreen").className = "fadeToBlack";
                    setTimeout(function () {
                        document.querySelector("#transitionScreen").className = "hidden";
    ...
    document.querySelector("#nextButtonStoryHeart2").addEventListener("click", function () {
    ...
    function chapterCheck() {
        if (currentChapter == 1) {
            ...
            document.querySelector("#storyImg").style.backgroundImage = "url(assets/checkEngine.png)";
            ...
            document.querySelector("#storyImg").style.backgroundImage = "url(assets/sky.png)";
            document.querySelector("#storyText").innerHTML = "";
            ...
            document.querySelector("#storyImg").style.backgroundImage = "url(assets/heart.png)";
            document.querySelector("#storyText").innerHTML = "";
            ...
            document.querySelector("#buttonHeartArea").className = "hidden";
            document.querySelector("#storyImg").className = "fadeInUp";
            document.querySelector("#storyImg").style.backgroundImage = "url(assets/passenger.png)";
            document.querySelector("#storyText").innerHTML = "";
            textPosition = 0;
            ...
            let storeMarker = L.marker([34.063514, -118.309849], { icon: pinIcon }).addTo(map);
            polyline2 = L.polyline(homeToStore, { color: 'blue', weight: 5 }).addTo(map);
            polyline6 = L.polyline(homeToStore2, { color: 'green', weight: 5 }).addTo(map);

            document.querySelector("#locationSearchOverlay").innerHTML = `
                <h1>What will it take to get to the store in the future?</h1>
                <label>Location A</label>
                <br><select id="addressInputA" required>
                    <option value=""></option>
                    <option value="a">[HOME] 6525 Normandie Ave, Los Angeles, CA 90044</option>
            ...
            document.querySelector("#buttonHeartArea").className = "hidden";
            document.querySelector("#storyImg").className = "fadeInUp";
            document.querySelector("#storyImg").style.backgroundImage = "url(assets/gate.png)";
            document.querySelector("#storyText").innerHTML = "";
            textPosition = 0;
            typeWriter(storyText6);
            ...
            document.querySelector("#tablet").innerHTML = `
                ...
                <div id="newsArticle">
                    <h3>LA RAIL CELEBRATES 200TH ANNIVERSARY</h3>
                    <p>In celebration of the 200th year of the modern LA Rail System, the Rail Authority has made all fares free for the day.</p>
                </div>
            `;
            addTabletButton();
            ...
            let schoolMarker = L.marker([34.076714, -118.452897], { icon: pinIcon }).addTo(map);
            polyline3 = L.polyline(homeToSchool, { color: 'blue', weight: 5 }).addTo(map);
            polyline7 = L.polyline(homeToSchool2, { color: 'green', weight: 5 }).addTo(map);

            document.querySelector("#locationSearchOverlay").innerHTML = `
                <h1>What will it take to get to school in the future?</h1>
                <label>Location A</label>
                <br><select id="addressInputA" required>
                    <option value=""></option>
                    <option value="a">[HOME] 6525 Normandie Ave, Los Angeles, CA 90044</option>
            ...
            document.querySelector("#buttonHeartArea").className = "hidden";
            document.querySelector("#storyImg").className = "fadeInUp";
            document.querySelector("#storyImg").style.backgroundImage = "url(assets/flowers.png)";
            document.querySelector("#storyText").innerHTML = "";
            textPosition = 0;
            typeWriter(storyText7);
            ...
            document.querySelector("#tablet").innerHTML = `
                ...
                <div id="newsArticle">
                    <h3>SUPERBLOOM IN THE LA HILLS</h3>
                    <p>Over 1,500 acres surrounding LA are currently in bloom. Many are flocking to enjoy nature and take pictures.</p>
                </div>
            `;
            ...
            document.querySelector("#tabletButton").addEventListener("click", function () {
                ...
                if (tabletNext == false) {
                    tabletNext = true;
                    setTimeout(function () {
                        document.querySelector("#questionButton").style.top = "60px";
                        document.querySelector("#questionButton").style.left = "60px";
                        document.querySelector("#questionButton").className = "";
                    }, 10000);
                }
            });
            ...
            document.querySelector("#questionButton").className = "hidden";
            document.querySelector("#storyScreen").className = "";
            document.querySelector("#nextButtonStory").style.display = "none";
            document.querySelector("#nextButtonStoryHeart2").className = "";
            document.querySelector("#buttonHeartArea2").className = "hidden";
            document.querySelector("#buttonHeartArea2").className = "";

            document.querySelector("#storyImg").style.backgroundImage = "url(assets/heartgood.png)";
            document.querySelector("#storyText").innerHTML = "";

            document.querySelector("#storyImg").className = "fadeInUp";
            textPosition = 0;
            typeWriter(storyText8);

        } else if (currentChapter == 23) {

            setTimeout(function () {
                document.querySelector("#storyScreen").className = "hidden";
                document.querySelector("#endingScreen").className = "";
                document.querySelector("main").className = "hidden";
            }, 2000);
